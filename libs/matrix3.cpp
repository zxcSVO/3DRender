...
matrix3 getRotationMatrixXY(const float& angle) {
...
matrix3 getRotationMatrixYZ(const float& angle) {
...
matrix3 getRotationMatrixXZ(const float& angle) {
